...
import { UserType, CheckoutUser, TestDataHelper } from "../../lib/testdata/testDataConstants";
...
test.describe('Cart', () => {
    ...
    test('checkout', { tag: ['@critical'] }, async ({ inventoryPage, mainNavigation, cartPage, checkoutPage }) => {
        ...
        await checkoutPage.checkoutLastName.fill(checkoutUser.lastName);
        await checkoutPage.checkoutPostalCode.fill(checkoutUser.postalCode);
